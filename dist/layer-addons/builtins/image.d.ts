...
import type { ImageLayerShaderBinding, ImagePlacementUniformNodes, RuntimeMaterial, WebGpuImageSampleNodeData } from "../../skybox/types";
...
export declare function applyImageLayerPlacementToShaderUniforms(material: THREE.ShaderMaterial, bindings: ImageLayerShaderBinding[], layerId: string, placement: SkyboxImagePlacement | null): void;
...
export declare function updateImageTextureUniforms(material: THREE.ShaderMaterial, bindings: ImageLayerShaderBinding[], imageTextures: Map<string, THREE.Texture>): void;
