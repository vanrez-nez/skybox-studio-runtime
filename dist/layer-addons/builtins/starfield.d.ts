...
export declare function updateStarfieldScreenTextureNodes(sampleData: Map<string, WebGpuStarfieldSampleNodeData>, screenTextures: Map<string, THREE.Texture>): void;
